...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `reservations` (Name,Email,Phone,Checkin,Checkout,Guest,Room,Suite,Request) VALUES ('$name','$email','$phone','$checkin','$checkout','$guest','$room','$suite','$request')";
                ...
                <form action="#" method="post">
                  ...
                  <div class="row">
                      <div class="col-sm-6 form-group">
                          ...
                          <div style="position: relative;">
                            ...
                            <input type='text' class="form-control" id='arrival_date' name="Checkin" id="checkin" />
                          </div>
                      </div>
                      ...
                      <div class="col-sm-6 form-group">
                          ...
                          <div style="position: relative;">
                            <span class="fa fa-calendar icon" style="position: absolute; right: 10px; top: 10px;"></span>
                            <input type='text' class="form-control" id='departure_date' name="Checkout" id="checkout" />
                          </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <textarea name="Request" id="request" class="form-control " cols="30" rows="8"></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 form-group">
