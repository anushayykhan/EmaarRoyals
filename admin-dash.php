                    ...
                    <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                      <thead>
                        ...
                        <tr>
                          ...
                          <th scope="col" class="px-3 text-muted">Request</th>
                      </thead>
                      <tbody>
                        <?php $srno = 1;
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                          <tr>
                            ...
                            <td><a href="add-booking.php?guest_id=<?php echo $row['Id']; ?>" class="btn btn-success">Book</a>


                              <a href="admin-dash.php?deleteId=<?php echo $row['Id'] ?>" class="btn btn-danger">Cancel</a>
                            </td>
                          <?php $srno++;
                        } ?>
                      </tbody>
